...
export default function CreateCollectionModal({
  ...
  return (
    <div
      className="fixed inset-0 z-[100000] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-200 cursor-pointer"
      onClick={onClose}
    >
      <div
        className="w-full max-w-md rounded-2xl bg-[#0d0d14] border border-white/[0.1] shadow-2xl p-6 text-white space-y-5 cursor-default"
