...
from routers import image, video, voice, pipeline, assets, settings as settings_router, analytics, brand_kit, publish, characters, apify, prompts, metadata
...
app.include_router(metadata.router, dependencies=api_security)
